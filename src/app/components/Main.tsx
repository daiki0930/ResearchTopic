...
export function MainSearchForm() {
  ...
  const fetchTheme = async (data: FormValues) => {
    ...
    console.log("----responseが表示される----", responseData)

    setValue("theme", responseData.theme);
    console.log("----themeが表示される----", responseData.theme)

    setValue("contents",responseData.content);
    console.log("----contentが表示される----", responseData.content)
    // setTheme(data.theme);
    // setContent(data.content);
  };

  const theme = watch("theme");
  console.log("----themeが表示される1----", theme)
  const content = watch("contents");
  console.log("----contentが表示される1----", content)
  ...
  return (
    <div className="flex justify-center items-center h-[2300px] flex-col bg-gradient-to-b from-[#f5ba61] to-[#eecfb6]">
      ...
      <div className="flex flex-col justify-center items-center text-[25px] h-screen">
        ...
        />
        {errors.interests1 && <p className="text-red-500">{errors.interests1?.message}</p>}
        ...
        />
        {errors.interests2 && <p className="text-red-500">{errors.interests2?.message}</p>}
        ...
        />
        {errors.interests3 && <p className="text-red-500">{errors.interests3?.message}</p>}
        ...
        />
        {errors.interests4 && <p className="text-red-500">{errors.interests4?.message}</p>}
